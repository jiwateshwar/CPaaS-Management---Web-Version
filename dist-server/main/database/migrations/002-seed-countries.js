...
const migration = {
    ...
    name: 'seed-countries',
    up: (db) => {
        const insertCountry = db.prepare('INSERT OR IGNORE INTO country_master (code, name, iso_alpha3, iso_numeric) VALUES (?, ?, ?, ?)');
        const insertAlias = db.prepare("INSERT OR IGNORE INTO country_aliases (country_code, alias, source) VALUES (?, ?, 'seed')");
        ...
        db.prepare("INSERT OR IGNORE INTO app_settings (key, value) VALUES ('default_currency', 'USD')").run();
        db.prepare("INSERT OR IGNORE INTO app_settings (key, value) VALUES ('date_format', 'YYYY-MM-DD')").run();
    },
};
exports.default = migration;
//# sourceMappingURL=002-seed-countries.js.map