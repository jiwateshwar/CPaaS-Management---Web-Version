...
class TrafficRepository extends base_repository_1.BaseRepository {
    list(params) {
        let where = 'WHERE 1=1';
        const qp = [];
        if (params.client_id) {
    ...
    `;
      ...
      ${where}
    `;
        return this.paginate(baseQuery, countQuery, { ...params, sortBy: params.sortBy || 'tr.traffic_date' }, qp);
    }
...
//# sourceMappingURL=traffic-repository.js.map